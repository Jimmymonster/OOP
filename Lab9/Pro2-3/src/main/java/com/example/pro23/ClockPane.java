...
public class ClockPane extends Pane {
    ...
    public void getW(double w) {this.w = w;paintClock();}
    ...
    protected void paintClock() {
        ...
        Text t5 = new Text(centerX - 20, centerY + clockRadius + 15,String.valueOf((int)this.hour)+":"+String.valueOf((int)this.minute)+":"+String.valueOf((int)this.second));
